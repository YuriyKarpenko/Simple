...
public static class CollectionExtensions
{
    ...
    public static bool TryGet<TKey, TValue, R>(this IDictionary<TKey, TValue> d, TKey key, [MaybeNullWhen(false)] out R result)
#else
...
#if NETSTANDARD2_1_OR_GREATER || NET5_0_OR_GREATER
    public static bool TryGet<TKey, TValue, R>(this IReadOnlyDictionary<TKey, TValue> d, TKey key, [MaybeNullWhen(false)] out R result)
#else

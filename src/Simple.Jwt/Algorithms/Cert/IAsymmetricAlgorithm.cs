...
/// <summary> Represents an asymmetric algorithm to generate or validate JWT signature. </summary>
public interface IAsymmetricAlgorithm : IJwtAlgorithm
{
    /// <summary> Verifies provided byte array with provided signature. </summary>

...
/// </summary>
public sealed class ES256 : ECDSA
{
    /// <summary>
    /// Creates an instance of <see cref="ES256" /> using the provided pair of public and private keys.
    /// </summary>
    ...
    public ES256(ECDsa publicKey, ECDsa privateKey)
        : base(publicKey, privateKey)
    {
    }

    /// <summary>
    /// Creates an instance of <see cref="ES256" /> using the provided public key only.
    /// </summary>
    /// <remarks>
    /// An instance created using this constructor can only be used for verifying the data, not for signing it.
    /// </remarks>
    /// <param name="publicKey">The public key for verifying the data.</param>
    public ES256(ECDsa publicKey)
        : base(publicKey)
    {
    }
    ...
    public ES256(X509Certificate2 cert)
        : base(cert)
    {
    }
